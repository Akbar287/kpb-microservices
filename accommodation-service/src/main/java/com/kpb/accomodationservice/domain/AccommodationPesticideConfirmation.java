...
@Entity
@Data
@Table(name = "accommodation_pesticide_confirmations")
public class AccommodationPesticideConfirmation implements Serializable {
    @Serial
    private static final long serialVersionUID = -6283155326252559492L;

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long accommodation_pesticide_confirmation_id;
