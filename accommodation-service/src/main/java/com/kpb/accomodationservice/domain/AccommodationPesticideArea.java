...
@Entity
@Data
@Table(name = "accommodation_pesticide_area")
public class AccommodationPesticideArea implements Serializable {
    @Serial
    private static final long serialVersionUID = -6283155328552559809L;

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long accommodation_pesticide_area_id;
